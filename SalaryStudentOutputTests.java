...
public class SalaryStudentOutputTests {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("My salary with a £200.50 increase is "+ mySalary.salaryIncrease(26000.10)); //Task 2
        //System.out.println("My salary with a 10% increase is "+ mySalary.salaryIncrease(60000.00, 10)); //Task 3
        //System.out.println("My monthly pay is now "+ mySalary.calculatePay(25000.00)); //Task 4
